...
describe "Test select_ingredient class function" do
    it "returns updated value" do
        ...
        # expect(recipes.test(ingredient)).to eq("1.5kg whole chicken")
        # this test worked when testing "return index"
        # expect(recipes.test(ingredient)).to eq(0)
        # this test worked when testing "return item.ingredients[ingredient]"
        # expect(recipes.test(ingredient)).to eq(true)
    end
end
