...
describe 'Test selected_recipes' do
  it 'returns an array of ingredients' do
    ...
    expect(recipes.selected_recipes).to eq([
      { '1.5kg whole chicken' => true, '3 fresh whole rosemary sprigs' => false,
        '¼ cup melted butter' => true }, { '1 cup grated cheddar cheese' => false, '1 handful tortilla chips' => false, '1 medium red capsicum finely chopped' => false, '2 sheets puff pastry' => false, '2 tbsp chopped coriander' => false, '400g can mixed beans drained' => false, '8 jalapeños chopped' => false, '⅓ cup chopped shallots' => false }
    ])
  end
end
